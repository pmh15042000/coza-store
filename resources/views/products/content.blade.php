                            ...
                            <div class="wrap-slick3-dots">
                                <ul class="slick3-dots" style="" role="tablist">
                                    <li class="slick-active" role="presentation">
                                        <img src="{{ asset('/storage/images/products/500/'.$product->image) }}">
                                        <div class="slick3-dot-overlay"></div>
                                    </li>
                                    @foreach ($list_thumb as $key => $sub)
                                    <li role="presentation">
                                        <img src="{{ asset('/storage/images/products/500/'.$sub) }}">
                                        <div class="slick3-dot-overlay"></div>
                                    </li>
                                    @endforeach
                                </ul>
                                    ...
                                    <div class="slick-list draggable">
                                        <div class="slick-track" style="opacity: 1; width: 1539px;">
                                            <div class="item-slick3 slick-slide slick-current slick-active"
                                                    data-thumb="{{ asset('/storage/images/products/500/'.$product->image) }}" data-slick-index="0"
                                                    aria-hidden="false"
                                                ...
                                                <div class="wrap-pic-w pos-relative">
                                                    <img src="{{ asset('/storage/images/products/500/'.$product->image) }}" alt="IMG-PRODUCT">
                                                    <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                                        href="{{ asset('/storage/images/products/500/'.$product->image) }}" tabindex="0">
                                        ...
                                        @foreach ($list_thumb as $key => $sub)
                                            <div class="item-slick3 slick-slide slick-current slick-active"
                                                    data-thumb="{{ asset('/storage/images/products/500/'.$sub) }}" data-slick-index="0"
                                                    aria-hidden="false"
                                                    style="width: 513px; position: relative; left: 0px; top: 0px; z-index: 999; opacity: 1;"
                                                    tabindex="0" role="tabpanel" id="slick-slide10"
                                                    aria-describedby="slick-slide-control10">
                                                        <div class="wrap-pic-w pos-relative">
                                                            <img src="{{ asset('/storage/images/products/500/'.$sub) }}" alt="IMG-PRODUCT">
                                                            <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                                                href="{{ asset('/storage/images/products/500/'.$sub) }}" tabindex="0">
                                                                <i class="fa fa-expand"></i>
                                                            </a>
                                                        </div>  
                                            </div>
