        ...
        <div class="wrap-slick1">
            <div class="slick1">
                ...
                @foreach($sliders as $slider)
                    ...
                    <div class="item-slick1" style="background-image: url({{ ('http://pmhstore.io/public/storage/images/sliders/1200/'. $slider->thumb) }});">
                ...
                @foreach($menus as $menu)
                    <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                        ...
                        <div class="block1 wrap-pic-w">
                            <img src="{{ asset('/storage/images/menus/300/'.$menu->thumb) }}" alt="IMG-BANNER">
